  ...
  return (
    <div className="space-y-6">
      <Card className="flex flex-col items-center py-8">
        <div className="w-24 h-24 rounded-full bg-slate-800 flex items-center justify-center mb-4 overflow-hidden border-2 border-slate-700 cursor-pointer hover:border-primary transition-colors relative group" onClick={triggerFileInput}>
          {profesional.logo ? (
        ...
        <button onClick={triggerFileInput} className="text-sm font-medium text-primary hover:underline">Cambiar Logo</button>
      </Card>

      <Card>
        <h3 className="font-semibold text-slate-100 mb-4">Información Personal</h3>
      ...
      <Card>
        <h3 className="font-semibold text-slate-100 mb-4">Información de Pago</h3>
        <div className="space-y-4">
